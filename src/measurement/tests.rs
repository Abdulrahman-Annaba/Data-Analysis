use crate::measurement::{newportmodel835powermeter::NewportModel835PowerMeterMeasurement, thorlabspm100a::ThorLabsPM100A_S120VC_PowerMeterMeasurement, measurement::{Measurement, AbsoluteUncertainty}};
#[test]
fn test_newport_measurement() {
    ...
    let correct_measurement_uncertainty = measurement*(reading_frac_uncertainty + fullscale_frac_uncertainty);
    assert_eq!(correct_measurement_uncertainty, newport_measurement.uncertainty());
}
...
fn test_thorlabs_pm100a_s120vc_measurement() {
    ...
    let thorlabs_measurement = ThorLabsPM100A_S120VC_PowerMeterMeasurement::new(measurement);
    // Test value
    ...
    assert_eq!(correct_measurement_uncertainty, thorlabs_measurement.uncertainty());
}